...
- **A menubar-json snapshot poll no longer validates every Codex rollout just to decide whether the snapshot is still exact.** Codex is hashed from path/mtime/size. A rewritten rollout still misses.
